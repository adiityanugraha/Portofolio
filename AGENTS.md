...
Personal portfolio for **Anak Agung Aryadipa Aditya Nugraha**, an AI and Machine Learning Engineer. Built with TanStack Start and deployed on Netlify.

## Project Overview

Portfolio site with About, Certifications, Projects, and Contact pages. Dark theme with violet/indigo accent. Fixed sidebar layout with profile info and navigation.
